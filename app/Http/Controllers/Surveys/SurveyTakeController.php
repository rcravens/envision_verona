...
use AssetIQ\Models\Surveys\SurveyQuestion;
use AssetIQ\Models\Surveys\SurveyQuestionTypeOptions;
use AssetIQ\Models\Surveys\SurveySection;
use AssetIQ\Models\Surveys\SurveySectionCopy;
...
class SurveyTakeController extends Controller
{
	public function __construct()
	{
		$this->middleware( 'role:' . implode( ',', [ SecurityRoleOptions::SurveyAdmin ] ), [
			'except' => [ 'submit_file', 'submit_answer', 'submit_answers', 'take', 'clone_section', 'remove_cloned_section', 'print' ]
		] );
	}
