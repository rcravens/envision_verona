    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="app-top-nav">
            <ul class="flex flex-col items-center p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                @if(!isset($hide_menu))
                    <x-nav-link :href="route('home.dashboard1')" :active="request()->routeIs('home.dashboard1')">{{__('Home')}}</x-nav-link>
                    <x-nav-link :href="route('home.dashboard1')" :active="request()->routeIs('home.xxx')">{{__('Population')}}</x-nav-link>
                    <x-nav-link :href="route('home.dashboard1')" :active="request()->routeIs('home.xxx')">{{__('Housing')}}</x-nav-link>
                    <x-nav-link :href="route('home.dashboard1')" :active="request()->routeIs('home.xxx')">{{__('Projects')}}</x-nav-link>
                    <x-nav-link :href="route('home.dashboard1')" :active="request()->routeIs('home.xxx')">{{__('About')}}</x-nav-link>
